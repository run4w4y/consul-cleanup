...
This example matches the deployment shape used by `examples/nomad-pack`: Terraform creates the Consul/Nomad policies, configures Vault roles for dynamic credentials, and stores the HTTP bearer token used by `consul-cleanup serve`.
